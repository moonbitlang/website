      ...
      <main className={styles['contest-main']}>
        ...
        <div className={styles['section-wrapper']}>
          <article className={styles['contest-article']}>
            ...
            <p>
              MoonBit
              编程创新挑战赛是由粤港澳大湾区数字经济研究院基础软件中心主办，面向全球开发者的挑战大赛。大赛目标是以编程竞赛推动计算机软件开发专业建设，助力人工智能云原生领域创新人才梯队培育，培养编程语言这一基础软件领域的后备人才。本大赛鼓励开发者通过设计、开发创新性计算机系统项目，学习人工智能云原生开发平台，培养系统级的设计、分析、优化与应用能力，提升开发技术、创新实践、团队协作能力。大赛服务国家人才培养战略，以赛促学、以赛促教，为高水平计算机人才成长搭建交流、展示、合作的开放平台。
            </p>
            <h2>二、赛道设置</h2>
