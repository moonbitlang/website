...
<h1>🌟 决赛通知</h1>
<a href='/files/2025-mgpic/final.pdf'>
  2025 MoonBit 全球编程创新挑战赛决赛通知
</a>
...
本次大赛分为[游戏开发挑战赛](https://tianchi.aliyun.com/competition/entrance/532403/information)、[程序语言设计和实现赛](https://tianchi.aliyun.com/competition/entrance/532402/information)

1. [游戏开发挑战赛](https://tianchi.aliyun.com/competition/entrance/532403/information)：面向14岁以上的开发者，使用 MoonBit 编程语言进行开发，优先推荐使用官方游戏框架：如 [pixel adventure.mbt](https://github.com/moonbitlang/pixel-adventure.mbt) 、[Wasm-4](https://github.com/moonbitlang/wasm4)、[Selene](https://github.com/moonbit-community/selene) 等。
2. [程序语言设计和实现赛](https://tianchi.aliyun.com/competition/entrance/532402/information)：面向14岁以上的开发者，使用 MoonBit 编程语言在 RISC-V 后端硬件平台开发。
...
1. 赛事采取阿里云天池竞赛平台报名：
   可前往 MoonBit 官方赛事活动页了解详情：https://www.moonbitlang.cn/2025-mgpic/
...
- 大赛报名者默认同意大赛的主办方公开赛道参赛作品源代码。大赛主办方拥有免费使用参赛作品进行演示和出版的权利（不涉及技术细节）。如果以盈利为目的使用参赛作品，需与参赛队协商，经参赛队同意后，签署有关对参赛作品使用的协议。但如届时开源协议允许商业化使用，主办方将按开源协议约定执行，不再另行与参赛团队协议或取得参赛团队同意。
...
<div className={styles['logos']}>
  <div className={styles['logo']}>
    <img src='/img/2025-contest/idea.png' alt='' />
  </div>
</div>
<h3>协办单位</h3>
<div className={styles['logos']}>
...
<div>
  <div className={styles['logos']}>
    <div className={clsx(styles['logo'], styles['logo--iscas-2025'])}>
      <img
        className={styles['logo--iscas-img']}
        src='/img/2025-contest/iscas.png'
        alt=''
      />
    </div>
    <div className={styles['logo']}>
...
<div className={styles['judges']}>
  ...
  <div className={styles['judge__bib']}>
    ...
    <div className={styles['judge__title']}>中国科学院软件研究所，所长</div>
  </div>
  <div className={styles['judge__video']}>
  ...
  <div className={styles['judge__bib']}>
    ...
    <div className={styles['judge__title']}>
      <span>IEEE终身会士、香港工程科学院院士、</span>
      <br />
      <span>香港科技大学（广州）创校校长</span>
    </div>
  </div>
</div>
...
报名比赛，我们即默认参赛选手您同意并自愿遵守参赛确认书的全部内容
