  ...
  return (
    <>
      <section className={styles.intro}>
        ...
        <p>本赛事面向希望成为 MoonBit 生态奠基者的开发者，鼓励参赛者充分发挥<strong>大模型在代码生成、结构推演与工程协作方面的优势</strong>，并结合 MoonBit 在类型系统、工具链与工程约束方面的能力，合成<strong>具备工程可行性、可维护性和长期价值的高质量软件系统</strong>。</p>
      ...
      <section id="timeline">
        ...
        <ul>
          ...
          <li><strong>申报评审：</strong>赛事组滚动审核申报书，审核将在申报 2 周内邮件通知预答辩</li>
          <li><strong>开发周期：</strong>预答辩通过，代码提交次数满足要求后</li>
          <li><strong>评选截至：</strong>2026 年 4 月 21 日</li>
          <li><strong>统一答辩与优秀作品评选：</strong>2026 年 4 月 27 日（暂定）</li>
        </ul>
      ...
      <section id="process">
        ...
        <h3>阶段三：获得立项支持</h3>
        <p>通过预答辩后，并在两周内提交 100 次代码（commit），可获得 1,500 元/人资金支持</p>
        ...
        <h4>项目规模参考</h4>
        <p>为保证项目具备足够的工程深度，赛事建议参赛项目的<strong>有效 MoonBit 代码量</strong>至少 <strong>10,000 行</strong>。</p>
        ...
        <p>答辩优异的项目，将获得赛事设定的总奖金池 <strong>15 万元现金奖励</strong>。相关奖励的具体形式与发放安排，将以主办方后续决赛公告为准。</p>
        <p>本次线下答辩计划是在深圳，时间计划是 4 月 27 日，如有改动，会提前通知选手。</p>
      </section>
      ...
      <section id="rewards">
        ...
        <ul>
          ...
          <li><strong>发放时间：</strong>项目预答辩通过，有 100 次提交后。</li>
        ...
        <p><strong>发放时间：</strong>线下答辩后 2 周内</p>
        <p><strong>发放条件：</strong>参与线下答辩的项目中，赛事评审组将对线下答辩项目进行专业评审，本次设立特等奖（1 名）、一等奖（1 名）、二等奖（2 名）、三等奖（3 名）、优异奖，赛事组将按照以下维度评选优秀作品，最终名单根据奖项根据实际质量和评分综合确定。</p>
        <ul>
          <li>解决实际应用问题（25%）</li>
          <li>提供完整用户体验（25%）</li>
