---
description: "How SeekMoon rethinks the development environment for agent collaboration with richer code review, visualization, and syntax-tree search."
slug: seekmoon-from-ide-to-ade
image: /img/blogs/2026-09-01-seekmoon-from-ide-to-ade/cover.png
tags: [MoonBit, AI]
---
...
![A completed HashSet refactoring task displayed alongside a split-view Diff Review in SeekMoon](./seekmoon-task-workspace-overview-en.png)
...
![The same collect_stdout change compared in line-level and Token Diff views](./seekmoon-diff-line-token-comparison-en.png)
...
![The same HashSet refactoring compared in line-level and Syntax Tree Diff views](./seekmoon-diff-line-tree-comparison-en.png)
...
![The references list for MoonDiffMode open in SeekMoon Diff Review, with related code previewed](./seekmoon-diff-ide-references.png)
...
![SeekMoon renders an inline Mermaid architecture diagram in a MoonBit source file and folds top-level implementations automatically](./seekmoon-code-visualization.png)
...
![SeekMoon syntax-tree search finds 43 matches across nine files in the core workspace](./seekmoon-code-search.png)
...
SeekMoon is now open source. Visit [moonbitlang/openseek](https://github.com/moonbitlang/openseek) to explore the code, build it, and try it for yourself. We also invite you to join us in this exploration as we move the development environment from IDE to ADE.
